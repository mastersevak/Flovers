...
*/
class AuthItemController extends BController
{
	/**
	...
	*/
	...
	{
		$this->pageTitle = t('rights', 'Разрешения');
    	...
    	Yii::app()->user->rightsReturnUrl = array('authItem/permissions');
		...
		$columns = array(
			array(
    			'name'=>'name',
    			'htmlOptions'=>['class'=>'hidden authname'],
	...
	*/
	public function actionGenerate()
	{
		...
		// We need the existing operations for comparison
