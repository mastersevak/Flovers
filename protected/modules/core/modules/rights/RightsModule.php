...
* ),
*/
class RightsModule extends BaseModule
{
	public $moduleName = 'rights';
	/**
	...
	*/
	public function registerScripts()
	{
		...
		$cs->registerScriptFile($this->assetsUrl.'/js/rights.js');
		$cs->registerCssFile($this->assetsUrl.'/css/core.css');
		...
		if( $this->cssFile!==false )
		{
			...
			if( $this->cssFile===null )
				$this->cssFile = $this->assetsUrl.'/css/default.css';
			else
