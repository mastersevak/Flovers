...
<?php $form=$this->beginWidget('SActiveForm', array(
	...
	<div class="row clearfix">
		...
		<span class="field w300 mb10">
			<?=$form->dropDownList($model, 'status', 
				...
				array('class'=>'uniform','empty'=>t('admin', 'Not selected'))); ?>
		</span>
	...
	<div class="row clearfix">
		...
		<span class="field">
			<?=$form->textArea($model,'content',array('style'=>'width:335px')); ?>
		</span>
	</div>

	<div class="row clearfix">
		<?=$form->label($model,'meta_title'); ?>
		<span class="field">
	...
	<div class="row clearfix">
		<?=$form->label($model,'meta_keywords'); ?>
		<span class="field">
	...
	<div class="row clearfix">
		<?=$form->label($model,'meta_description'); ?>
		<span class="field">
