...
/**
 * CLASS LOOKUP
 * Так как статус записи хранится в БД в виде числа, нам необходимо получить его текстовое 
 * представление для отображения пользователям. Для больших систем такое требование 
 * является довольно типичным.
 * 
 ...
 * Первый возвращает список строк для заданного типа данных, 
 * второй — конкретную строку для заданного типа данных и значения.
 *
...
class Lookup extends AR
{
    ...
    public function behaviors(){
        return CMap::mergeArray(parent::behaviors(), array(
            ...
            'ml' => [
                ...
                'langTableName' => 'lookup_lang',
                'langForeignKey' => 'id_lookup',
    ...
    public function getBackUrl(){
        return app()->createUrl('core/admin/lookup/update', array('id'=>$this->id));
    }
