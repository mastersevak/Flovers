...
class Settings extends AR
{
    ...
    public function getBackUrl(){
        return app()->createUrl('core/admin/settings/update', array('id'=>$this->id));
    }
    ...
    private static function loadItems()
    {
        ...
        Yii::app()->cache->set($cacheKey, self::$_items, 0/*, $dependency*/); //чтобы он каждый раз не обращался к базе, а мы вручную сбрасывали бы кеш
