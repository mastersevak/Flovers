...
(function($) {
	...
	$.fn.elPaddingInput = function(o) {
		...
		this.empty().addClass(opts['class'])
			...
			.append(this.right).append(this.uright).append(' x ').append('<br>')
