...
return array(
	...
	'aliases' => array(
        ...
        'market'	 => 'app.modules.market',
        'pricelist'  => 'app.modules.pricelist',
	...
	'components'=> CMap::mergeArray( array(
		...
		'clientScript' => array(
			...
			'packages' => array(
				...
				'socket.io' => array(
					'basePath' => 'core.assets.js.libraries',
					'js' => array('socket.io.js'),
					'depends' => array('jquery')
				),

				'sockets' => array(
					'basePath' => 'core.assets',
					'js' => array('js/main/socket.init.js'),
					'depends' => array('jquery', 'socket.io')
				),
	...
	'params' => CMap::mergeArray( array(
		...
		'languages'=>array('ru'=>'RU'/*, 'en'=>'EN', 'hy'=>'HY'*/),
		'defaultLanguage'=>'ru',
