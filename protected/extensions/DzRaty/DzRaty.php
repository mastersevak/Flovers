...
class DzRaty extends CInputWidget
{
	...
	public function run()
	{
		...
		// in original ext. openTag was 'div', for template megatron was needed to change to 'span'
		echo CHtml::openTag('span', $this->htmlOptions) . '</span>' . $output_textfield;
	...
	protected function registerClientScript()
	{
		...
		if ( ! $cs->isScriptRegistered(__CLASS__.'#defaults', CClientScript::POS_END) )
		{
			$js_default = '';
