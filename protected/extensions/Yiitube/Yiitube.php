...
class Yiitube extends CWidget {
	...
	public function init()
	{
		...
		//set custom sizes
		if(isset($this->params['width']) && is_numeric($this->params['width'])){
			$this->size = 'custom';
			$this->_width[$this->player][$this->size] = $this->params['width'];
		}

		if(isset($this->params['height']) && is_numeric($this->params['height'])){
			$this->size = 'custom';
			$this->_height[$this->player][$this->size] = $this->params['height'];
		}
	}
